...
#include<GL/glut.h>
#include<math.h>
static int m=0,M=0,v=0,V=0,E=0,e=0,r=0,R=0,j=0,J=0,s=0,S=0,U=0,u=0,n=0,N=0,X=0,z=0,B=0,b=0,
c=0;
bool START = false;
static GLint axis=2;
...
void frontscreen(void)
{
    ...
    glColor3f(0,0,1);
    glRasterPos3f(-1.8,1.5,0);//position
    char msg1[]="GOPALAN COLLEGE OF ENGINEERING AND MANAGEMNET";
    for(int i=0;i<strlen(msg1);i++)
        glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, msg1[i]);
    glColor3f(0.7,0,1);
    glRasterPos3f(-.9,1.3,0);
    ...
    glColor3f(255,255,0);
    glRasterPos3f(-1,-1.2,0);
    char msg10[]= "Dr MANJU V";
    for(int i=0;i<strlen(msg10);i++)
        glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, msg10[i]);
    glColor3f(1,0.1,1);
    glRasterPos3f(-.3,-1.5,0);
    char msg11[]="PRESS ENTER TO PROCEED";
